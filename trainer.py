...
class Trainer(object):
    """build a trainer"""
    def __init__(self, model, optimizer, criterion, device, start_epoch, max_epoch,
    ...
    def train(self):
        ...
        return self.iou_best, self.iou_0_best, self.iou_1_best, self.state_best
    ...
    def test(self):
        ...
        iou, iou_0, iou_1 = label_accuracy_score(seg_t_all, seg_p_all, n_class=2)
        if self.iou_best < iou:
            self.iou_best = iou
            self.iou_0_best = iou_0
            self.iou_1_best = iou_1
            self.state_best = deepcopy(self.model.state_dict())
        print("iou: {:.3f}\t0_iou: {:.3f}\t1_iou: {:.3f}\n".format(iou, iou_0, iou_1))
